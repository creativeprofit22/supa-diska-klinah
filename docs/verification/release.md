...
**Unsigned release candidate: automated gates and non-elevated acceptance passed; elevated install/uninstall and the installer UAC/SmartScreen observations were accepted by the user on 2026-09-26, as were the per-operation UAC counts, the parity drivers on the installed build and the four build-artifact drill items; the Spanish review, published update and the signed run remain open.** No release has been published from this candidate.
