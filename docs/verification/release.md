...
**Unsigned release candidate: automated gates and non-elevated acceptance passed; elevated install/uninstall, UAC observations, the Spanish review and the signed run remain open.** No release has been published from this candidate.
...
| Installed-build offline, uninstall cleanup | not run | **Open**: needs an elevated session and a person to answer UAC |
