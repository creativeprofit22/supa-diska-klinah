...
Do not copy, translate, or adapt MangoDisk source into this MIT project. Future cleanup behavior must be independently implemented from platform documentation and permissively licensed references. Choosing to incorporate GPL-covered implementation would require an explicit project licensing decision before any code enters the repository.
